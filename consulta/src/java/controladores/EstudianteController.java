...
import administrares.EstudianteFacade;
...
public class EstudianteController implements Serializable {
    ...
    @EJB
    private administrares.EstudianteFacade ejbFacade;
    ...
    public Estudiante getEstudiante(java.math.BigDecimal id) {
    ...
    public static class EstudianteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estudiante) {
                ...
                return getStringKey(o.getEstudianteid());
            } else {
