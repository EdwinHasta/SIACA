...
import administrares.ProfesorFacade;
...
public class ProfesorController implements Serializable {
    ...
    @EJB
    private administrares.ProfesorFacade ejbFacade;
    ...
    public Profesor getProfesor(java.math.BigDecimal id) {
    ...
    public static class ProfesorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Profesor) {
                ...
                return getStringKey(o.getProfesorid());
            } else {
