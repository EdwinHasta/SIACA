...
import administrares.ProgramaacademicoFacade;
...
@Named("programaacademicoController")
@SessionScoped
public class ProgramaacademicoController implements Serializable {
    ...
    @EJB
    private administrares.ProgramaacademicoFacade ejbFacade;
    ...
    public Programaacademico getProgramaacademico(java.math.BigDecimal id) {
    ...
    public static class ProgramaacademicoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getProgramaacademico(getKey(value));
        }
